        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{__('locale.Product Add')}}</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{url('/admin/home')}}">{{__('locale.Home Page')}}</a>
                        </li>
                        <li class="breadcrumb-item active">{{__('locale.Product Add')}}
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col s6 m6 l6 input-field">
                            <div class="row">
                                <div class="col s12 m12 l12 input-field">
                                    <label for="name">{{__('locale.Product Name')}}</label>
                                    <input id="name" name="name" type="text"
                                           data-error=".errorTxt2" required>
                                    <small class="errorTxt2"></small>
                                </div>
                                <div class="col s12 m12 l12 input-field">
                                    <label for="description">{{__('locale.Product Description')}}</label>
                        ...
                        <div class="col s12 m6 l6">
                            <input type="file" id="user_image" name="user_image"
                                   ...
                                   data-allowed-file-extensions="jpeg jpg png svg" required/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            <div class="input-field">
                                <select class="select2 browser-default" name="category_select2[]" id="category_select2" multiple>

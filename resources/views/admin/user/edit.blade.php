            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/admin/users-list')}}">Users List</a>
                        </li>
                        <li class="breadcrumb-item active"><a href="{{url('/admin/users-list')}}">User Edit</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <ul class="tabs mb-2 row">
                    <li class="tab">
                        <a class="display-flex align-items-center" href="#account">
                            <i class="material-icons mr-1">person_outline</i><span>{{__('locale.General')}}</span>
                        </a>
                    </li>
                </ul>
                                    ...
                                    <div class="row">
                                        <div class="media">
                                            <a class="ml-10 pl-10" href="#">
                                                <img
                                                    src="{{isset($user->photo) ? asset('storage/images/user-profile/'.$user->photo) : ''}}"
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="user-edit-btns display-flex">
                                                    ...
                                                    <a href="javascript:void(0);" id="remove-image"
                                                       class="btn-small btn-light-pink">Rasdasdeset</a>
                                                </div>
...
@section('page-script')
    ...
    <script>
        $('#accountForm').on('submit', function (event) {
            ...
            $.ajax({
                url: "{{ route('admin.user.general.update') }}",
                type: 'POST',
        ...
        $("#remove-image").on("click", function (event) {
            ...
            $.ajax({
                url: "{{ route('admin.user.image.remove') }}",
                type: 'POST',
                data: {
                    id: user_id,
                    _token: CSRF_TOKEN,
